...
gerçekleştirirken, verilerin işlenmesi, depolanması ve iletilmesi aşamalarında ikili (binary), onluk (decimal), sekizlik (octal) ve onaltılık (hexadecimal) gibi farklı sayı sistemleri kullanılmaktadır. |
