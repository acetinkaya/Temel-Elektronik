...
(NOT: Birimleri yazmayı unutmayınız) | Seri devrelerde dirençler uç uca bağlanır ve içlerinden aynı akım geçer. Bu devrede üç direnç (4, 6 ve 10 ohm) seri şekilde bağlandığı için, toplam dirençleri doğrudan toplanır. Toplam direnç = 4 + 6 + 10 = 20 ohm
