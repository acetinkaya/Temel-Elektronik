...
| Bir elektrikli ısıtıcı 220 V gerilimle çalışıyor ve 1100 W güç harcıyor. Bu ısıtıcı 5 saat çalıştırılırsa harcadığı-saat (kWh) olur? | Enerji = Güç × Zaman 'dir. Güç--> 1100 watt = 1.1 kilowatt , Zaman: 5 saat , Enerji = 1.1 kW × 5 saat = 5.5 kWh , Isıtıcı 5 saatte 
5.5 kilowatt-saat enerji harcar |
