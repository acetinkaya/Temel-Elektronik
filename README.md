...
| Ohm Kanunu nedir? Aşama Aşama örnekleyerek formül üzerinde anlatımınızı yapınız? | Ohm Kanunu, elektrik devrelerinde gerilim (V), akım (I) ve direnç (R) arasındaki ilişkiyi açıklar. Bu kanuna göre, bir iletkenden geçen akım miktarı, uygulanan gerilimle doğru; direnciyle ters orantılıdır.
