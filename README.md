...
|Kondansatörler çeşitleri nelerdir? Devre elemanı olarak temel görevi nedir? | Kondansatör; iki iletken levha arasına yalıtkan (dielektrik) bir madde yerleştirilerek oluşturulmuş bir devre elemanıdır.  |
|||
|||
|||
|----------------------|---------------------------------------|
