...
Diyot, elektriğin yalnızca bir yönde akmasına izin veren bir yarı iletken devre elemanıdır. Doğru polarma altında iletken, ters polarma altında ise yalıtkandır. Bu özelliğiyle alternatif akımı doğru akıma çevirmede (doğrultma) kullanılır. Diyotlar; Doğrultucu diyot, Zener Diyot, Led diyot, Schottky diyot, 
