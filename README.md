...
|----------------------|--------------------------------|   
|  Diyot kavramı  nedir? |  Diyot, iki uçtan "anot ve katot"  oluşan yarı iletken bir devre elemanı olup elektriği yalnızca tek yönde iletirken diğer yönde yalıtım yapan  
